# **FIG Assessment Example 3 Code Review and Edits**

> This repository contains my code review and edits for Example 3 of the [FIG Code Review Assessment](https://github.com/andrewbarnettfig/FIG.CodeReview.Assessment2025).
